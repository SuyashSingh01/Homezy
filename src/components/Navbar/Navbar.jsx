...
const Navbar = () => {
  ...
  return (
    <header
      className={` mx-auto fixed top-0 z-10 flex w-screen flex-col justify-center mb-4 bg-white p-2 ${hasShadow ? "shadow-md" : ""
        }`}
    >
      ...
      {/* Category Navigation */}
      {showSearchBar && (
        <div className=" mt-2 flex flex-wrap items-center justify-between px-10 py-4 border-b border-gray-200 bg-white">
          {/* Categories Section */}
